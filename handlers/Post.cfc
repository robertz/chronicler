component extends="coldbox.system.EventHandler" {
	...
	function index( event, rc, prc ){
		...
		var base = event.getHTMLBaseURL().left(event.getHTMLBaseURL().len() -1);
		...
		prc.meta = [
			...
			"<meta property="" og:image"" content=""#base##prc.post.cover_image#"" />",
			"<meta name=""twitter:image"" content=""#base##prc.post.cover_image#"" />",
